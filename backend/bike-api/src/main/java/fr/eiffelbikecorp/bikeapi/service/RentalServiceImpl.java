...
public class RentalServiceImpl implements RentalService {
    ...
    public ReturnBikeResponse returnBike(Long rentalId, ReturnBikeRequest request) {
        ...
        bikeRepository.save(bike);
        // Remove from waiting list (served)
        waitingListEntryRepository.delete(nextEntry);
        Notification notification = Notification.builder()
                .entry(nextEntry) // note: entry object still exists in memory; ok for message mapping
    ...
    public List<NotificationResponse> listMyNotifications(Long customerId) {
